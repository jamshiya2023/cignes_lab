                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row g-4" id="singletestcheckbox">
                                    ...
                                    <label class="form-label mb-1">Single Tests</label>
                                    ...
                                    @endphp
                                        ...
                                        <input type="checkbox" class="singletest" name="singletest[]" value="{{$test->id}}" checked> {{$test->testname}}
                                        </div>
                                        @endforeach   
                                       
                                       @foreach($remainingsingletest as $remaintest)

                                       <div class="col-sm-2 mt-2">
                                        <input type="checkbox" class="singletest" name="singletest[]" value="{{$remaintest->id}}"> {{$remaintest->testname}}
                                        </div>
                                       @endforeach
