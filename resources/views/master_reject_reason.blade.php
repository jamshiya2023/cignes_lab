            ...
            <div class="container-fluid">
                <div class="row">
                                            ...
                                            <table id="rejectreason" class="table card-table table-hover align-middle mb-0" style="width: 100%;">
                                                ...
                                                @foreach($rejectreasons as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td>
                                                        @php if($value->rejectreason_arabic) { $arabicname = $value->rejectreason_arabic; } else { $arabicname = '-NA-'; } @endphp    
                                                        {{ $arabicname }}</td>
                    ...
                    @endforeach
                            ...
                            <form class="row g-3" id="addrejectreason" name="addrejectreason" method="post" action="{{ route('rejectreason.add') }}">                            
                                @csrf
                                            ...
                                            <div class="modal-body custom_scroll">
                                                <div class="row g-4">
                                                    ...
                                                    <div class="col-sm-6 text-end">
                                                        <label class="form-label">Reject Reason (Arabic)</label>
