                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="card-title m-0">Purchase List</h6> <a href="{{ url('/add-purchase') }}" class="btn btn-primary">New Purchase</a>
                                ...
                                <table id="myAllDoctor" class="table card-table table-hover align-middle mb-0" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Reference No</th>
                                            <th>Supplier</th>
                                            <th class="text-center">Purchased Status</th>
                                            <th class="text-center">VAT Total</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td>June 05, 2022 09:10 am</td>
                                            <td>000001</td>
                                            <td>PO5789</td>
                                            <td>Maya Group</td>
                                            <td class="text-center"><span  class="btn btn-sm bg-success text-white" style="padding: .10rem .5rem; width:120px;">Received</span></td>
                                            <td class="text-center">0.00</td>
                                            <td class="text-center">65.00</td>
                                            <td class="text-center">50.00</td>
                                            <td class="text-center">15.00</td>
                                            <td class="text-center"><span  class="btn btn-sm bg-warning text-dark" style="padding: .10rem .5rem; width:120px;">Pending</span></td>                                            
                                        ...
                                        <tr>
                                            ...
                                            <td>PO5789</td>
                                            <td>Maya Group</td>
                                            <td class="text-center"><span  class="btn btn-sm bg-danger text-white" style="padding: .10rem .5rem; width:120px;">Returned</span></td>
                                            <td class="text-center">0.00</td>
                                            <td class="text-center">65.00</td>
                                            <td class="text-center">50.00</td>
                                            <td class="text-center">15.00</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>PO5789</td>
                                            <td>Maya Group</td>
                                            <td class="text-center"><span  class="btn btn-sm bg-dark text-white" style="padding: .10rem .5rem; width:120px;">Completed</span></td>
                                            <td class="text-center">0.00</td>
                                            <td class="text-center">65.00</td>
                                            <td class="text-center">50.00</td>
                                            <td class="text-center">15.00</td>
                                            <td class="text-center"><span  class="btn btn-sm bg-success text-white" style="padding: .10rem .5rem; width:120px;">Paid</span></td>                                            
                                            <td class="text-center">
                                                <a href="#" class="btn btn-link btn-sm text-secondry" data-bs-toggle="modal" data-bs-target="#" aria-label="View">
                                                    <i class="fa fa-eye" style="color:#2966ca;"></i>
                                                </a>
