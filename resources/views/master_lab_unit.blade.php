                                ...
                                <div class="col-xl-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table id="labunit" class="table card-table table-hover align-middle mb-0" style="width: 100%;">
                                                <thead>
                                                    <tr>
                                                        <th style="width:3%">#</th>
                                            ...
                                            <div class="modal-body custom_scroll">
                                                <div class="row g-4">
                                                    ...
                                                    <div class="col-sm-6 text-end">
                                                        <label class="form-label">Lab Unit (Arabic)</label>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body custom_scroll">
                                                <div class="row g-4">
                                                    ...
                                                    <div class="col-sm-6 text-end">
                                                        <label class="form-label">Lab Unit Name (Arabic)</label>
