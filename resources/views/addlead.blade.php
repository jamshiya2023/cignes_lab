    ...
    .expirydate{ z-index:99999 !important; }
       ...
       <div class="page-body px-xl-4 px-sm-2 px-0 py-lg-2 py-1 mt-3">
            <div class="container-fluid">
				<div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    	...
                    	<div class="row g-4"> 
                <form class="row g-3" id="addlead" name="addlead" method="post" action="{{ route('lead.add') }}">                            
                @csrf
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="card-title mb-0">Add  Lead</h6>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="row g-4">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <input type="text" class="form-control form-control-lg" name="leadtitle" id="leadtitle" > 
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <input type="text" class="form-control form-control-lg" name="contactname" >
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <select class="form-select form-select-lg" name="leadstatus" id="leadstatus">
                                            ...
                                            <option value="{{$liststatus->id}}">{{$liststatus->leadstatus_name}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <label class="form-label">Note </label>                          
                                        <input type="text" class="form-control form-control-lg" name="note" id="note" > 
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                ...
                <input type="time" class="form-control" value="10:05 AM" name="contacttime" >
                ...
                <input type="date"  class="form-control form-control-lg" name="contactdate" id="" > 
        ...
        <select class="form-select form-select-lg" name="assignedstaff" id="assignedstaff">
        <option value="">--Please Select--</option>
      
        @foreach ($leadstaff as $liststaff)
        <option value="{{$liststaff->id }}">{{$liststaff->firstname}}</option>
         @endforeach
         </select>
...
function formValidation() 
{
    ...
    document.getElementById('assignedstaffalert').style.display = 'none';
      ...
      if(document.addlead.leadtitle.value == ''){
        document.getElementById('leadtitlealert').style.display = 'block'; 
        document.addlead.leadtitle.focus();  
        return false;  
      }
      if(document.addlead.contactname.value == ''){
        document.getElementById('contactnamealert').style.display = 'block'; 
        document.addlead.contactname.focus();  
        return false;  
      }
      if(document.addlead.contactnumber.value == ''){
        document.getElementById('contactnumberalert').style.display = 'block'; 
        document.addlead.contactnumber.focus();  
        return false;     
    } 
     if(IsNumeric(document.addlead.contactnumber.value)==false){
        document.getElementById('contactnumberalert').style.display = 'block'; 
        document.getElementById("contactnumberalert").innerHTML="Invalid contact number! Please re-enter";
        document.addlead.contactnumber.select();
        document.addlead.contactnumber.focus(); 
        return false;
    }if(document.addlead.leadstatus.value == ''){
        document.getElementById('leadstatusalert').style.display = 'block'; 
        document.addlead.leadstatus.focus();  
        return false;  

      }if(document.addlead.email.value != ''){

if (!filter.test(emails.value)) {
 
    document.getElementById('emailalert').style.display = 'block'; 
    document.getElementById("emailalert").innerHTML="Invalid email address! Please re-enter";
    document.addlead.email.select();
    document.addlead.email.focus();
    return false;
}
}
    
    
    if(document.addlead.contacttime.value == ''){
        document.getElementById('contacttimealert').style.display = 'block'; 
        document.addlead.contacttime.focus();  
        return false; 
    }if(document.addlead.contactdate.value == ''){
        document.getElementById('contactdatealert').style.display = 'block'; 
        document.addlead.contactdate.focus();  
        return false; 
    }if(document.addlead.assignedstaff.value == ''){
        document.getElementById('assignedstaffalert').style.display = 'block'; 
        document.addlead.assignedstaff.focus();  
        return false; 
    }
