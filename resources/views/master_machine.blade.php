                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="card">
                            ...
                            @if(\Session::get('success'))
                                ...
                                @endif
                            <div class="card-body">
                                <table id="tblmachine" class="table card-table table-hover align-middle mb-0" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th style="width:5%">#</th>
                            ...
                            <div class="modal-dialog modal-lg modal-dialog-scrollable">
                                <div class="modal-content">
                                    ...
                                    <div class="col-sm-6 text-end">
                                        <label class="form-label">Machine Name (Arabic)</label>                                        
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body custom_scroll">
                                    <div class="row g-4">
                                        ...
                                        <div class="col-sm-6">
                                            <label class="form-label text-end">Machine Name (Arabic)</label> 
