...
<style>
            ...
            <div class="container-fluid">
                <div class="row">
                                ...
                                <div class="col-xl-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h6 class="card-title m-0">Lab Sensitivity</h6><a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-sample-type">Add Sensitivity</a>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table id="sensitivity" class="table card-table table-hover align-middle mb-0" style="width: 100%;">
                                            
                                                <thead>
                                                    <tr>
                                                        <th style="width:3%">#</th>
                                                        <th style="width:90%">Sensitivity Name</th>
                                                ...
                                                @foreach($sensitivity as $key => $value)
                                                    <tr >
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <a href="{{ 'block-sensitivity/'.$value->id }}"  onclick="return confirm('Do you want to block this lot code?')" class="btn btn-link btn-sm text-info" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Active" aria-label="Active">
                                                                <i class="fa fa-ban" style="color:#198754;"></i>                                                                
                                                            </a>
                                                            <?php } else { ?>
                                                                <a href="{{ 'unblock-sensitivity/'.$value->id }}" onclick="return confirm('Do you want to unblock this lot code?')" class="btn btn-link btn-sm text-danger" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Blocked" aria-label="Blocked">
                    ...
                    @endforeach
                            ...
                            <form class="row g-3" id="addsensitivity" name="addsensitivity" method="post" action="{{ route('sensitivity.add') }}">                            
                                @csrf
                                <div class="modal fade" id="add-sample-type" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog modal-lg modal-dialog-scrollable">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">Lab Sensitivity</h5>
                                                <button type="button" id="add-modal-close-x" class="btn-close"></button>
                                            </div>
                                            <div class="modal-body custom_scroll">
                                                <div class="row g-4 mb-2">
                                                    <div class="col-sm-6">
                                                        <label class="form-label">Sensitivity Name <span class="red">*</span></label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="sensitivityname" id="sensitivityname" >
                                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="sensitivitynamealert" style="display:none ;">Please enter sensitivity name </div>                                                
                                                    </div>                                    
                                                <!-- </div>  

                                                <div class="row g-4"> -->
                                                    <div class="col-sm-6">
                                                        <label class="form-label">Zone of Inhibition</label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="inhibitionzone" id="inhibitionzone" >
                                                ...
                                                <div class="row g-4 mb-2">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="sensitivityminvalue" id="sensitivityminvalue" >
                                                ...
                                                <div class="row g-4"> -->
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="sensitivitymaxvalue" id="sensitivitymaxvalue" >
                                                        
                                                    </div>                                    
                                                </div>
                                                <div class="row g-4 mb-2">
                                                    <div class="col-sm-6">
                                                        <label class="form-label">Sensitivity Zone</label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="sensitivityzone" id="sensitivityzone" >
                                                ...
                                                <div class="row g-4"> -->
                                                    <div class="col-sm-6">
                                                        <label class="form-label">Intermediate Value</label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="intermediatevalue" id="intermediatevalue" >
                                                        
                                                    </div>                                    
                                                </div>
                                                <div class="row g-4">
                                                    <div class="col-sm-6">
                                                        <label class="form-label">Antibiotic Short Name</label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="antibioticshortname" id="antibioticshortname" >
                                            ...
                                            <div class="modal-footer">
                                                <a class="btn btn-primary" onclick="addsensitivityValidation();">Save</a>
                            ...
                            <form class="row g-3" name="editsensitivity" method="post" action="{{ route('sensitivity.edit') }}">                            
                                @csrf
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body custom_scroll">
                                                <div class="row g-4 mb-2">
                                                    <div class="col-sm-6">
                                                        <label class="form-label">Sensitivity Name <span class="red">*</span></label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="sensitivitynameedit" id="sensitivitynameedit" >
                                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="sensitivitynameeditalert" style="display:none ;">Please enter sensitivity name </div>                                                
                                                    </div>                                    
                                                <!-- </div>  
                                                ...
                                                <div class="row g-4"> -->
                                                    <div class="col-sm-6">
                                                        <label class="form-label">Zone of Inhibition</label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="inhibitionzoneedit" id="inhibitionzoneedit" >
                                                ...
                                                <div class="row g-4">
                                                    <div class="col-sm-6">
                                                        <label class="form-label">Min</label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="sensitivityminvalueedit" id="sensitivityminvalueedit" >
                                                ...
                                                <div class="row g-4"> -->
                                                    <div class="col-sm-6">
                                                        <label class="form-label">Max</label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="sensitivitymaxvalueedit" id="sensitivitymaxvalueedit" >
                                                ...
                                                <div class="row g-4">
                                                    <div class="col-sm-6">
                                                        <label class="form-label">Sensitivity Zone</label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="sensitivityzoneedit" id="sensitivityzoneedit" >
                                                ...
                                                <div class="row g-4"> -->
                                                    <div class="col-sm-6">
                                                        <label class="form-label">Intermediate Value</label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="intermediatevalueedit" id="intermediatevalueedit" >
                                                ...
                                                <div class="row g-4">
                                                    <div class="col-sm-6">
                                                        <label class="form-label">Antibiotic Short Name</label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="antibioticshortnameedit" id="antibioticshortnameedit" >
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a class="btn btn-primary" onclick="editsensitivityValidation();">Save</a>
    ...
    $('#add-modal-close-x, #add-modal-close').click(function() {
        $('#sensitivityname').val('');
        $('#sensitivitynamealert').hide();
        $('#inhibitionzone').val('');
        $('#sensitivityminvalue').val('');
        $('#sensitivitymaxvalue').val('');
        $('#sensitivityzone').val('');
        $('#intermediatevalue').val('');
        $('#antibioticshortname').val('');

        $('#add-sample-type').modal('hide');
    });

    $('#edit-modal-close-x, #edit-modal-close').click(function() {
        $('#sensitivitynameeditalert').hide();
        $('#edit-sample-type').modal('hide');
    });

   
    function addsensitivityValidation() {
        document.getElementById('sensitivitynamealert').style.display = 'none';
        if(document.addsensitivity.sensitivityname.value == ''){
            document.getElementById('sensitivitynamealert').style.display = 'block';  
            document.addsensitivity.sensitivityname.focus(); 
            return false;     
        }
    document.addsensitivity.submit();
    return true;
    }
    ...
    function editview(id){
        ...
        $.ajax({
            ...
            success: function(response){
                $('#sensitivitynameedit').val(response.sensitivity_name);
                $('#inhibitionzoneedit').val(response.inhibition_zone);
                $('#sensitivityminvalueedit').val(response.sensitivity_min_value);
                $('#sensitivitymaxvalueedit').val(response.sensitivity_max_value);
                $('#sensitivityzoneedit').val(response.sensitivity_zone);
                $('#intermediatevalueedit').val(response.intermediate_value);
                $('#antibioticshortnameedit').val(response.antibiotic_short_name);
    ...
    function editsensitivityValidation() {
        if(document.editsensitivity.sensitivitynameedit.value == ''){
            document.getElementById('sensitivitynameeditalert').style.display = 'block';  
            document.editsensitivity.sensitivitynameedit.focus(); 
            return false;     
        }
        
    document.editsensitivity.submit();
    return true;
    }
    </script>
