...
<style>
                                ...
                                <div class="col-xl-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table id="testmethod" class="table card-table table-hover align-middle mb-0" style="width: 100%;">
                                                <thead>
                                                    <tr>
                                                        <th style="width:3%">#</th>
                                            ...
                                            <div class="modal-body custom_scroll">
                                                <div class="row g-4">
                                                    ...
                                                    <div class="col-sm-6 text-end">
                                                        <label class="form-label">Test Method (Arabic)</label>
    ...
    function edittestmethodValidation() {
        if(document.edittestmethod.testmethodnameedit.value == ''){
            document.getElementById('testmethodnamealertedit').style.display = 'block';  
            document.edittestmethod.testmethodnameedit.focus(); 
            return false;     
        }
    document.edittestmethod.submit();
    return true;
    }
    </script>
