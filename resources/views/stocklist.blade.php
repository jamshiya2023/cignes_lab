                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <h6 class="card-title m-0">Stock List</h6> <a href="{{ url('/add-stock-list') }}" class="btn btn-primary">Add Stock</a>
                                    ...
                                    @foreach ($itempurchases as $purchases)
                                        ...
                                        <td>{{$i}}</td>
                                            ...
                                            <td>{{$purchases->warehouse}}</td>   
                                             <td>{{$purchases->sellingprice}}</td> 
                                            <td>@php if($purchases->openingstock) { $arabicname = $purchases->openingstock;} else { $arabicname = '-NA-';} @endphp    
                                            {{$arabicname}}</td>
                                            ...
                                            <td>
                                                ...
                                                <a  onclick="viewstock('{{$purchases->id }}');"class="btn btn-link btn-sm text-secondry" data-bs-toggle="modal" data-bs-target="#view-sample-type{{ $purchases->id }}" aria-label="View"> 
                                                    <i class="fa fa-eye" style="color:#2966ca;"></i>
                                                </a>
...
@endforeach
                            ...
                            <div class="modal fade" id="stocklistview" tabindex="-1">
                                ...
                                <div class="modal-dialog modal-lg">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" id="closestockview"></button>
                                    </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                <strong>Warehouse : </strong><span id="warehouse"></span>
