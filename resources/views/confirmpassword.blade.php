                ...
                <div class="row">
                    <div class="col-lg-6 d-none d-lg-flex justify-content-center align-items-center">
                        <div style="max-width: 30rem;">
                            ...
                            <div class="mb-5">
                                <h2 class="color-900">Medical Laboratory Application</h2>
                            </div>
                            <!-- List Checked -->
                    ...
                    <div class="col-lg-6 d-flex justify-content-center align-items-center">
                        <div class="card shadow-sm w-100 p-4 p-md-5" style="max-width: 32rem;">
                            ...
                            <form class="row g-3" id="changepassword" name="changepassword" method="post" action="">   
                            ...
                            @csrf
                                ...
                                <div class="col-12 text-center mt-4">
                                    ...
                                    <input type="hidden" id="" name="foremail" value="{{session('foremail')}}">
...
function formValidation() 
{
    ...
    if(document.changepassword.newpass.value == ''){
        ...
        return false;     
    } else if(document.changepassword.confirmpass.value == ''){
        document.getElementById('confirmpassalert').style.display = 'block'; 
        document.changepassword.confirmpass.focus();  
        return false;     
    } else if(document.changepassword.newpass.value != document.changepassword.confirmpass.value){
        document.getElementById('confirmpassalert').style.display = 'block';
