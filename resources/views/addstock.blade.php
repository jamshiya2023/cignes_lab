            ...
            <div class="container-fluid">
				<div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    	...
                    	<div class="row g-4"> 
                <form class="row g-3" id="addpurchase" name="addpurchase" method="post" action="{{ route('stock.add') }}">                            
                @csrf
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="card-title mb-0">Add  Stock</h6>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="row g-4">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <select class="form-select form-select-lg" name="categoryid" id="categoryid"  onchange="loadsubcategory(this.value)">
                                    ...
                                    <div class="col-sm-6">
                                        <label class="form-label">Sub Category </label>                          
                                            <select id="subcategoryname" class="form-select form-select-lg" name="subcategoryid" id="subcategoryid">
                                                    <option value="">--Please Select--</option> 
                                            </select>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <select class="form-select form-select-lg" name="brandid" id="brandid">
                                            <option value="">--Please Select--</option>
                                    ...
                                    <div class="col-sm-6">
                                     ...
                                     <div class="col-sm-6">
                                        ...
                                        <select class="form-select form-select-lg" name="taxid" id="taxid">
                                            <option value="">--Please Select--</option>
                                            @foreach ($taxname as $listtax)
                                            <option value="{{$listtax->id}}">{{$listtax->taxname}}</option>
                                            @endforeach
                                        </select>
                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="taxidalert" style="display:none ;">Please enter item vat </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="vatmethodalert" style="display:none ;">Please enter vat method</div>                                
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <select class="form-select form-select-lg" name="unitid" id="unitid">
                                            <option value="">--Please Select--</option>
                                            @foreach ($unitname as $listunit)
                                            <option value="{{$listunit->id}}">{{$listunit->unit_name}}</option>
                                            @endforeach
                                        </select>
                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="unitidalert" style="display:none ;">Please select unit name</div>
                                    </div>
                                         ...
                                         <form>
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label class="form-label">{{$listwarehouse->warehouse_name}}</label>
                                                    <input type="hidden" class="form-control" name="warehouseid[]" id="warehouseid"  value="{{$listwarehouse->id}}">
...
function formValidation() 
{
    ...
    if(document.addpurchase.itemname.value == ''){
     ...
     if(IsNumeric(document.addpurchase.itemcost.value)==false){
        document.getElementById('itemcostalert').style.display = 'block'; 
        document.getElementById("itemcostalert").innerHTML="Invalid contact number! Please re-enter";
    ...
    if(document.addpurchase.sellingprice.value == ''){
     ...
     if(IsNumeric(document.addpurchase.sellingprice.value)==false){
        document.getElementById('sellingpricealert').style.display = 'block'; 
        document.getElementById("sellingpricealert").innerHTML="Invalid contact number! Please re-enter";
    ...
    /*
     if(document.addpurchase.taxid.value == ''){
        document.getElementById('taxidalert').style.display = 'block'; 
        document.addpurchase.taxid.focus();  
        return false; 
