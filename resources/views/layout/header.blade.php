                        ...
                        <li>
                            <div class="dropdown morphing scale-left notifications">
                                <a class="nav-link dropdown-toggle after-none" href="#" role="button" data-bs-toggle="dropdown">
                                    <span class="d-none d-xl-block me-2">Notifications <span class="badge bg-danger text-light">14</span></span>
                                ...
                                <div id="NotificationsDiv" class="dropdown-menu shadow rounded-4 border-0 p-0 m-0">
                                    <div class="card w380">
                                        ...
                                        <ul class="nav nav-tabs tab-card d-flex text-center" role="tablist">
                                            <li class="nav-item flex-fill"><a class="nav-link active" data-bs-toggle="tab" href="#Noti-tab-Message" role="tab">New Registrations</a></li>
                                                ...
                                                <ul class="list-unstyled list mb-0">
                                                    <li class="py-2 mb-1 border-bottom">
                                                        <a href="javascript:void(0);" class="d-flex">
                                                            <div class="avatar rounded-circle no-thumbnail">OT</div>
                                                    ...
                                                    <li class="py-2 mb-1 border-bottom">
                                                        <a href="javascript:void(0);" class="d-flex">
                                                        <div class="avatar rounded-circle no-thumbnail">DP</div>
                                                            <div class="flex-fill ms-3">
                                                    ...
                                                    <li class="py-2 mb-1 border-bottom">
                                                        <a href="javascript:void(0);" class="d-flex">
                                                        <div class="avatar rounded-circle no-thumbnail">RB</div>
                                                            <div class="flex-fill ms-3">
                                                    ...
                                                    <li class="py-2 mb-1 border-bottom">
                                                        <a href="javascript:void(0);" class="d-flex">
                                                        <div class="avatar rounded-circle no-thumbnail">ED</div>
                                                            <div class="flex-fill ms-3">
                                                    ...
                                                    <li class="py-2 mb-1 border-bottom">
                                                        <a href="javascript:void(0);" class="d-flex">
                                                        <div class="avatar rounded-circle no-thumbnail">CG</div>
                                                            <div class="flex-fill ms-3">
                                                    ...
                                                    <li class="py-2">
                                                        <a href="javascript:void(0);" class="d-flex">
                                                        <div class="avatar rounded-circle no-thumbnail">KO</div>
                                                            <div class="flex-fill ms-3">
                                ...
                                <div class="dropdown-menu border-0 rounded-4 shadow p-0">
                                    <div class="card border-0 w240">
                                        ...
                                        <div class="list-group m-2 mb-3">
                                            ...
                                            <a class="list-group-item list-group-item-action border-0" href="#"><i class="w30 fa fa-gear"></i>Change Password</a>
                                        </div>
