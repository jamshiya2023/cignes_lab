                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="card-title m-0">Audit Trail</h6> 
                                
                            </div>
                            <div class="card-body">
                                <table id="tblaudittrail" class="table card-table table-hover align-middle mb-0" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th width="5%">#</th>
                                            <th width="15%">Time</th>
                                    ...
                                    <tbody>
                                    @foreach($logactivities as $key => $value)
                                        <tr>
                                            <td>{{ ++$key }}</td>
                                            <td>{{$value->created_at}}</td>
                                            <td>{{ucwords($value->staff_name)}}</td>
                                            <td>{{$value->subject}}</td>  
                                            <td style="text-align:center;">
                                            <button type="button" class="btn btn-sm bg-dark text-white"  title="View Details" onclick="viewlogactivity({{$value->id}})">View</button>
                                            </td>
                        ...
                        <div class="modal fade" id="viewlogactivity" tabindex="-1" aria-hidden="true">
                                    ...
                                    <div class="modal-body custom_scroll">
                                        <table class="table table-borderless mb-0">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <strong>Date & Time : </strong><span id="datetime">2022-07-14 04:20:35</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    <strong>User : </strong><span id="user">Super admin</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    <strong>Method : </strong><span id="method">POST</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    <strong>IP Address : </strong><span id="ipaddress">127.0.0.1:8000</span>
                                                    </td>
                                                </tr>    
                                                <tr>
                                                    <td>
                                                    <strong>URL : </strong><span id="url">http://127.0.0.1:8000/additionaltestadd</span>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <span id="subject">Super admin added UltrasensitiveTSH as additional. Super admin added UltrasensitiveTSH as additional. Super admin added UltrasensitiveTSH as additional  </span>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <span id="useragent">Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:102.0) Gecko/20100101</span>
                                                    </td>
                                                </tr>
...
<!-- VIEW INVOICE MODAL ENDS HERE -->  
    ...
    <script>
        ...
        success: function(response){
           // alert(response.logactivities.agent); return false;

            $('#datetime').html(response.crdate+' '+response.crtime);
            $('#user').html(response.logactivities.staff_name);
            $('#method').html(response.logactivities.method);
            $('#ipaddress').html(response.logactivities.ip);
            $('#url').html(response.logactivities.url);
            $('#subject').html(response.logactivities.subject);
            $('#useragent').html(response.logactivities.agent);

            $('#viewlogactivity').modal('show');
