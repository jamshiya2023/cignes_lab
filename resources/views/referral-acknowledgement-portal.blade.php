                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="card-title m-0">Referral Acknowledgement</h6>
                                ...
                                <table id="myAllDoctor" class="table card-table table-hover align-middle mb-0" style="width: 100%;">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><a href="#" class="btn btn-primary badge" data-bs-toggle="modal" data-bs-target="#view">View</a></td>
                            ...
                            <div class="modal-dialog modal-lg modal-dialog-scrollable">
                                <div class="modal-content">
                                    <div class="modal-body custom_scroll p-lg-5">
                                        ...
                                        <h5 class="modal-title mb-2">Customers Details</h5>

										
                                        <div class="row">
                                        	<div class="col-lg-4 col-md-6 col-sm-12 mb-2" >
                                        	<div class="h6 mb-0">Name: Jaison Peter</div>
                                            </div>
                                            
                                            <div class="col-lg-4 col-md-6 col-sm-12 mb-2" >
                                        	<div class="h6 mb-0">Contact No: 9895432166</div>
                                            </div>
                                            
                                            <div class="col-lg-4 col-md-6 col-sm-12 mb-2" >
                                        	<div class="h6 mb-0">Place: Calicut</div>
                                            </div>
