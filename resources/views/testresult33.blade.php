                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="card-title m-0">Test Report</h6>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="text-align:center;">
                                             <a class="btn btn-sm bg-success text-white"  title="Edit Invoice" data-bs-toggle="modal" data-bs-target="#updateresult">Update</a>
                                             
                                             <button type="button" class="btn btn-sm bg-danger text-white"  title="View Report" data-bs-toggle="modal" data-bs-target="#invoice_detail">View / Print</button>
                                                        ...
                                                        <table class="table table-borderless table-striped mb-0">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="text-first" style="width:25%">Test</th>
                                                                    
                                                                    <th  class="text-center" style="width:25%">Test Result</th>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center"><input type="text" class="form-control form-control-lg"></td>
                                                                    <td class="text-center"><input type="text" class="form-control form-control-lg"></td>
