...
*/
 ...
 Route::post('addtestresult', [TestController::class, 'addtestresult']); 
...
Route::post('view-test', [AllTestsController::class, 'viewtest'])->name('test.view');
...
Route::post('edit-doc-method', [RegistrationController::class, 'docedit'])->name('doc.edit');
Route::post('view-test', [RegistrationController::class, 'viewdoc'])->name('doc.view');

Route::post('paymentadd', [RegistrationController::class, 'addpayment']);
//sm 
